...
public class RegistrationServiceImpl implements RegistrationService{
	...
	private final EmailValidatorServiceImpl emailValidatorServiceImpl;
	private final LoginSecurityServiceImpl loginSecurityServiceImpl;
	private final ConfirmationTokenServiceImpl confirmationTokenServiceImpl;
	private final EmailSenderService emailSenderService;

	@Override
	public String registerUser(RegistrationRequestBody registrationRequestBody) {

		if(!emailValidatorServiceImpl.test(registrationRequestBody.getEmail())) {
			throw new IllegalStateException("Not valid email");
		}

		String token = loginSecurityServiceImpl.signUpUser(Users.builder()
				.identificationNumber(registrationRequestBody.getIdentificationNumber())
				.name(registrationRequestBody.getName())
				.phoneNumber(registrationRequestBody.getPhoneNumber())
				.password(registrationRequestBody.getPassword())
				.email(registrationRequestBody.getEmail())
    ...
    public String confirmToken(String token) {
        ...
        loginSecurityServiceImpl.enableAppUser(
