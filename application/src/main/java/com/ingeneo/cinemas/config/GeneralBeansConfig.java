...
import com.ingeneo.cinemas.impl.MovieScheduleServiceImpl;
...
public class GeneralBeansConfig {
	...
	@Bean("movieScheduleServiceImpl")
	public MovieScheduleServiceImpl createMovieScheduleServiceImpl(MovieScheduleRepository movieScheduleRepository, 
			RoomRepository roomRepository, MovieRepository movieRepository){
		return new MovieScheduleServiceImpl(movieScheduleRepository, roomRepository, movieRepository);
	}
